...
$query = "
    ...
    WHERE a.category_id = (SELECT category_id FROM categories WHERE name = 'technology')
";
        ...
        <div class="row">
            <div class="col-lg-8 most-recent">
                ...
                <div class="row">
                    ...
                    if ($result->num_rows > 0) {
                        $firstArticle = true; // Flag untuk artikel pertama

                        while ($article = $result->fetch_assoc()) {
                            if ($firstArticle) {
                                // Artikel pertama dengan gambar lebih besar
                                ?>
                                <div class="col-lg-12 mb-4">
                                    <div class="card">
                                        <div class="card-header p-0 position-relative">
                                            <a href="blog-single.php?id=<?php echo $article['article_id']; ?>">
                                                <img class="card-img-top d-block radius-image" src="assets/images/<?php echo $article['image']; ?>" alt="Card image cap">
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="author align-items-center mt-3 mb-1">
                                                <a href="#author"><?php echo $article['nama_users']; ?></a>
                                            </div>
                                            <ul class="blog-meta">
                                ...
                                <?php
                                $firstArticle = false; // Set flag menjadi false setelah artikel pertama ditampilkan
                            } else {
                                // Artikel lainnya dengan tampilan kotak
                                ?>
                        ...
                        echo "<p>Tidak ada artikel di kategori 'technology'.</p>";
                    }
                    ?>
            ...
            <div class="col-lg-4 trending mt-lg-0 mt-5 mb-lg-5">
                <div class="pos-sticky">
                    ...
                    // Query untuk mengambil artikel trending dari kategori 'technology'
                    $query = "
                        SELECT a.*, u.nama_users 
                        FROM articles a 
                        JOIN users u ON a.user_id = u.user_id 
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<p>Belum ada artikel trending di kategori 'technology'.</p>";
                    }
                    ?>
            </div>
        </div>
